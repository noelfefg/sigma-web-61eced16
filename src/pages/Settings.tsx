...
export default function SettingsPage() {
  ...
  const tabs: { id: Tab; label: string; icon: JSX.Element }[] = [
    ...
    { id: 'kyc', label: 'Verification', icon: <LordIcon icon={ICONS.shield} size={20} trigger="hover" primary="1a56db" className="w-4 h-4" /> },
    { id: 'settings', label: 'Account', icon: <LordIcon icon={ICONS.user} size={20} trigger="hover" primary="1a56db" className="w-4 h-4" /> },
  ];
          ...
          <div className="space-y-4">
            ...
            <div className={`flex items-center gap-3 p-4 rounded-2xl border ${
              ...
              {kycStatus === 'approved' ? <CheckCircle2 className="w-5 h-5 text-green-500 shrink-0" /> :
               ...
               <LordIcon icon={ICONS.shield} size={20} trigger="hover" primary="1a56db" className="w-5 h-5 text-primary shrink-0" />}
              <div>
